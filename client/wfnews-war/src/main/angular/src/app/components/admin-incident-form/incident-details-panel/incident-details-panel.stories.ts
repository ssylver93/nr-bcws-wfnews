...
import { IncidentDetailsPanelComponent } from './incident-details-panel.component';
...
const meta: Meta<IncidentDetailsPanelComponent> = {
    title: 'Panels/IncidentDetailsPanelComponent',
    component: IncidentDetailsPanelComponent,
    decorators: [
        moduleMetadata({
            declarations: [IncidentDetailsPanelComponent],
            imports: [
                CommonModule,
                TextFieldModule,
                MatCardModule,
...
type Story = StoryObj<IncidentDetailsPanelComponent>;
