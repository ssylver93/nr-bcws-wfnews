...
import { ContactsDetailsPanelComponent } from './contacts-details-panel.component';
...
const meta: Meta<ContactsDetailsPanelComponent> = {
    title: 'Panels/ContactsDetailsPanelComponent',
    component: ContactsDetailsPanelComponent,
    decorators: [
        moduleMetadata({
            declarations: [ContactsDetailsPanelComponent],
...
type Story = StoryObj<ContactsDetailsPanelComponent>;
