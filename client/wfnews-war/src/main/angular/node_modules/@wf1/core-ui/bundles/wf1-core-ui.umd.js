(function (global, factory) {
    ...
    (function (IconType) {
        ...
        IconType["INCIDENT_FIELD_ACTIVITY_OTHER"] = "incident-field-activity-other";
        IconType["INCIDENT_FLOOD"] = "incident-flood";
        IconType["INCIDENT_FUELS_MANAGEMENT"] = "incident-fuels-management";
        IconType["INCIDENT_LANDSLIDE"] = "incident-landslide";
        IconType["INCIDENT_OTHER_EMERGENCY"] = "incident-other-emergency";
        IconType["INCIDENT_PRESCRIBED_FIRE"] = "incident-prescribed-fire";
        IconType["INCIDENT_TRAINING"] = "incident-training";
    ...
    (function (IncidentTypeFieldActivityOther) {
        IncidentTypeFieldActivityOther["ACTIVE"] = "wf1-incident-field-activity-other-icon-active";
        IncidentTypeFieldActivityOther["COMPLETED"] = "wf1-incident-field-activity-other-icon-completed";
    })(exports.IncidentTypeFieldActivityOther || (exports.IncidentTypeFieldActivityOther = {}));
    (function (IncidentTypeFlood) {
        IncidentTypeFlood["ACTIVE"] = "wf1-incident-flood-icon-active";
        IncidentTypeFlood["COMPLETED"] = "wf1-incident-flood-icon-completed";
    })(exports.IncidentTypeFlood || (exports.IncidentTypeFlood = {}));
    (function (IncidentTypeFuelsManagement) {
        IncidentTypeFuelsManagement["ACTIVE"] = "wf1-incident-fuels-management-icon-active";
        IncidentTypeFuelsManagement["COMPLETED"] = "wf1-incident-fuels-management-icon-completed";
    })(exports.IncidentTypeFuelsManagement || (exports.IncidentTypeFuelsManagement = {}));
    (function (IncidentTypeLandslide) {
        IncidentTypeLandslide["ACTIVE"] = "wf1-incident-landslide-icon-active";
        IncidentTypeLandslide["COMPLETED"] = "wf1-incident-landslide-icon-completed";
    })(exports.IncidentTypeLandslide || (exports.IncidentTypeLandslide = {}));
    (function (IncidentTypeOtherEmergency) {
        IncidentTypeOtherEmergency["ACTIVE"] = "wf1-incident-other-emergency-icon-active";
        IncidentTypeOtherEmergency["COMPLETED"] = "wf1-incident-other-emergency-icon-completed";
    })(exports.IncidentTypeOtherEmergency || (exports.IncidentTypeOtherEmergency = {}));
    (function (IncidentTypePrescribedFire) {
        IncidentTypePrescribedFire["ACTIVE"] = "wf1-incident-prescribed-fire-icon-active";
        IncidentTypePrescribedFire["COMPLETED"] = "wf1-incident-prescribed-fire-icon-completed";
    })(exports.IncidentTypePrescribedFire || (exports.IncidentTypePrescribedFire = {}));
    (function (IncidentTypeTraining) {
        IncidentTypeTraining["ACTIVE"] = "wf1-incident-training-icon-active";
        IncidentTypeTraining["COMPLETED"] = "wf1-incident-training-icon-completed";
    })(exports.IncidentTypeTraining || (exports.IncidentTypeTraining = {}));
    ...
    var circleHalo = "<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" width=\"40\" zoomAndPan=\"magnify\" viewBox=\"0 0 30 30.000001\" height=\"40\" preserveAspectRatio=\"xMidYMid meet\" version=\"1.0\"><circle stroke=\"#ffffffaa\" fill=\"none\" cx=\"15\" cy=\"14.5\" r=\"13.5\"></circle></svg>";
    var Icons = {
        incident: {
    ...
    var ApplicationIconComponent = /** @class */ (function () {
        function ApplicationIconComponent(iconRegistry, sanitizer) {
            ...
            registerIcon(exports.IconType.INCIDENT_FIELD_ACTIVITY_OTHER, Icons.incidentFieldActivityOther.icon);
            registerIcon(exports.IconType.INCIDENT_FLOOD, Icons.incidentFlood.icon);
            registerIcon(exports.IconType.INCIDENT_FUELS_MANAGEMENT, Icons.incidentFuelsManagement.icon);
            registerIcon(exports.IconType.INCIDENT_LANDSLIDE, Icons.incidentLandslide.icon);
            registerIcon(exports.IconType.INCIDENT_OTHER_EMERGENCY, Icons.incidentOtherEmergency.icon);
            registerIcon(exports.IconType.INCIDENT_PRESCRIBED_FIRE, Icons.incidentPrescribedFire.icon);
            registerIcon(exports.IconType.INCIDENT_TRAINING, Icons.incidentTraining.icon);
